...
export const ProdiNav = [
  ...
  },
  {
    items: [
      {
        href: "/dashboard/fakultas-prodi/evaluasi-diri",
        label: "Evaluasi Diri",
  ...
  },
  {
    items: [
      {
        href: "/dashboard/fakultas-prodi/daftar-temuan",
        label: "Daftar Temuan",
        icon: (
          <Icon
  ...
  },
  {
    items: [
      {
        href: "/dashboard/fakultas-prodi/hasil-desk-evaluation",
  ...
  },
  {
    items: [
      {
        href: "/dashboard/fakultas-prodi/manajemen-dokumen",
